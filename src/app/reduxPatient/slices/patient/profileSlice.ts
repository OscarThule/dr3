...
export const setAuthData = (token: string, patient: Patient, rememberMe: boolean = true): void => {
...
export const forgotPasswordPatient = createAsyncThunk(
  ...
  async (email: string, { rejectWithValue }) => {
    try {
      const res = await authAxios.post('/api/patients/forgot-password', { email })
      return res.data
    } catch (err: any) {
