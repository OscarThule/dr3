...
// Price helper functions with proper typing
...
export default function EntryPage() {
  ...
  const filterButtons = [
    ...
    { id: 'active' as FilterType, label: 'Active', count: stats.activeCenters },
    {
      ...
      label: 'Under R500',
      count: medicalCenters.filter(c => getConsultationFee(c) < 500).length,
    },
    {
      id: 'premium' as FilterType,
      label: 'Premium',
      count: medicalCenters.filter(c => getConsultationFee(c) > 800).length,
    },
  ];
              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  <select
                    ...
                    value={sortBy}
                    onChange={e => dispatch(setSortBy(e.target.value as SortByOption))}
                  >
                      ...
                      <div className="flex items-start space-x-3 sm:space-x-4">
                        ...
                        <div className="flex-grow">
                          ...
                          <p className="text-gray-600 text-xs sm:text-sm flex items-start sm:items-center mt-1">
                            <svg
                              className="w-3 h-3 sm:w-4 sm:h-4 mr-1 flex-shrink-0 mt-0.5 sm:mt-0"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
